...
>
> Lesson bodies here are a historical filled proof. They do **not** match today's lesson bars. For a new course, copy [`templates/LESSON_TEMPLATE.md`](https://github.com/droxey/Syllabus-Template/blob/master/templates/LESSON_TEMPLATE.md) — do not author from these modules.
>
