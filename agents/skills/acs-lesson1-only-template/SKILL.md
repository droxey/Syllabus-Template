...
---
# templates/LESSON_TEMPLATE.md is the sole Syllabus-Template starter
...
- **Never** treat `LessonNN.md` as published canonical content. `lessons/Lesson1.md` is a pointer only; do not treat LessonNN as published content you keep after you fill the course.
...
These must appear in every lesson copied from `templates/LESSON_TEMPLATE.md`:
...
- Do not restore Lesson2 as a "lab day" twin. Lab-heavy days still start from `templates/LESSON_TEMPLATE.md` and keep Activity 1 / Activity 2.
